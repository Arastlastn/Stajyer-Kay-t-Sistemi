...
public class Signin extends JFrame {
    ...
    private class SigninToLogin implements Runnable {
        @Override
        public void run() {
            if (new String(passwordFieldStajyer.getPassword()).equals(new String(passwordFieldStajyerTekrar.getPassword()))) {
                try { 
                ...
                JOptionPane.showMessageDialog(null, "Şifreler uyuşmuyor, lütfen tekrar deneyin.");
            }
        }
    }
}