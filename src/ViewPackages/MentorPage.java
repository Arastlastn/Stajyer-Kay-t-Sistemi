...
public class MentorPage extends JFrame {
	...
	public MentorPage(Mentor mentor) {
		...
		List<String> stajyers = MentorManager.getStajyer();
		...
		btnNewButtonOdevGönder.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// Görevi ekleme
					MentorManager.odevGir(textFieldBaslik.getText(), textAreaAciklama.getText(), sqlDate, tc);
				...
				MentorManager.stajyerGorevEsle(sellectedstajyers);
		...
		stajyerComboBoxDegerlendir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				List<Mission> missions = MentorManager.getGorevDetails(selectedTc);
	...
	private void updateMissionList(String tc) {
		...
		List<Mission> gorevDetails = MentorManager.getGorevDetails(tc);
